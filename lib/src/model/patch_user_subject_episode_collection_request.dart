...
/// * [type] 
@BuiltValue()
abstract class PatchUserSubjectEpisodeCollectionRequest implements Built<PatchUserSubjectEpisodeCollectionRequest, PatchUserSubjectEpisodeCollectionRequestBuilder> {
  ...
  factory PatchUserSubjectEpisodeCollectionRequest([void updates(PatchUserSubjectEpisodeCollectionRequestBuilder b)]) = _$PatchUserSubjectEpisodeCollectionRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PatchUserSubjectEpisodeCollectionRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PatchUserSubjectEpisodeCollectionRequest> get serializer => _$PatchUserSubjectEpisodeCollectionRequestSerializer();
}

class _$PatchUserSubjectEpisodeCollectionRequestSerializer implements PrimitiveSerializer<PatchUserSubjectEpisodeCollectionRequest> {
  @override
  final Iterable<Type> types = const [PatchUserSubjectEpisodeCollectionRequest, _$PatchUserSubjectEpisodeCollectionRequest];
