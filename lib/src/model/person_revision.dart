...
/// * [data] 
@BuiltValue()
abstract class PersonRevision implements Revision, Built<PersonRevision, PersonRevisionBuilder> {
  @BuiltValueField(wireName: r'data')
  BuiltMap<String, PersonRevisionDataItem>? get data;

  PersonRevision._();

  factory PersonRevision([void updates(PersonRevisionBuilder b)]) = _$PersonRevision;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PersonRevisionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PersonRevision> get serializer => _$PersonRevisionSerializer();
}

class _$PersonRevisionSerializer implements PrimitiveSerializer<PersonRevision> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.data != null) {
      ...
      yield serializers.serialize(
        object.data,
        specifiedType: const FullType(BuiltMap, [FullType(String), FullType(PersonRevisionDataItem)]),
      );
    }
    yield r'type';
    yield serializers.serialize(
