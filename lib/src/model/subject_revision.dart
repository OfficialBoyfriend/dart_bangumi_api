...
/// * [data] 
@BuiltValue()
abstract class SubjectRevision implements Revision, Built<SubjectRevision, SubjectRevisionBuilder> {
  @BuiltValueField(wireName: r'data')
  SubjectRevisionData? get data;

  SubjectRevision._();

  factory SubjectRevision([void updates(SubjectRevisionBuilder b)]) = _$SubjectRevision;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SubjectRevisionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubjectRevision> get serializer => _$SubjectRevisionSerializer();
}

class _$SubjectRevisionSerializer implements PrimitiveSerializer<SubjectRevision> {
  @override
