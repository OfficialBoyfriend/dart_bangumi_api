...
/// * [data] 
@BuiltValue()
abstract class PagedRevision implements Built<PagedRevision, PagedRevisionBuilder> {
  ...
  factory PagedRevision([void updates(PagedRevisionBuilder b)]) = _$PagedRevision;
  ...
  static Serializer<PagedRevision> get serializer => _$PagedRevisionSerializer();
}
