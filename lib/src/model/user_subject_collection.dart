...
/// * [subject] 
@BuiltValue()
abstract class UserSubjectCollection implements Built<UserSubjectCollection, UserSubjectCollectionBuilder> {
  ...
  factory UserSubjectCollection([void updates(UserSubjectCollectionBuilder b)]) = _$UserSubjectCollection;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UserSubjectCollectionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UserSubjectCollection> get serializer => _$UserSubjectCollectionSerializer();
}

class _$UserSubjectCollectionSerializer implements PrimitiveSerializer<UserSubjectCollection> {
  @override
  final Iterable<Type> types = const [UserSubjectCollection, _$UserSubjectCollection];
