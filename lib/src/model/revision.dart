...
class _$RevisionSerializer implements PrimitiveSerializer<Revision> {
  ...
  Revision deserialize(
    ...
    return serializers.deserialize(serialized, specifiedType: FullType($Revision)) as $Revision;
  }
}

/// a concrete implementation of [Revision], since [Revision] is not instantiable
@BuiltValue(instantiable: true)
abstract class $Revision implements Revision, Built<$Revision, $RevisionBuilder> {
  $Revision._();
