...
@BuiltValue()
abstract class UserSubjectCollectionModifyPayload implements Built<UserSubjectCollectionModifyPayload, UserSubjectCollectionModifyPayloadBuilder> {
  /// 修改条目收藏类型
  ...
  factory UserSubjectCollectionModifyPayload([void updates(UserSubjectCollectionModifyPayloadBuilder b)]) = _$UserSubjectCollectionModifyPayload;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UserSubjectCollectionModifyPayloadBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UserSubjectCollectionModifyPayload> get serializer => _$UserSubjectCollectionModifyPayloadSerializer();
}

class _$UserSubjectCollectionModifyPayloadSerializer implements PrimitiveSerializer<UserSubjectCollectionModifyPayload> {
  @override
  final Iterable<Type> types = const [UserSubjectCollectionModifyPayload, _$UserSubjectCollectionModifyPayload];
