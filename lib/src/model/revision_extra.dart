...
/// * [img] 
@BuiltValue()
abstract class RevisionExtra implements Built<RevisionExtra, RevisionExtraBuilder> {
  @BuiltValueField(wireName: r'img')
  String? get img;

  RevisionExtra._();

  factory RevisionExtra([void updates(RevisionExtraBuilder b)]) = _$RevisionExtra;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RevisionExtraBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RevisionExtra> get serializer => _$RevisionExtraSerializer();
}
