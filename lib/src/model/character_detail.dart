...
/// * [stat] 
@BuiltValue()
abstract class CharacterDetail implements Built<CharacterDetail, CharacterDetailBuilder> {
  ...
  factory CharacterDetail([void updates(CharacterDetailBuilder b)]) = _$CharacterDetail;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CharacterDetailBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CharacterDetail> get serializer => _$CharacterDetailSerializer();
}

class _$CharacterDetailSerializer implements PrimitiveSerializer<CharacterDetail> {
  @override
