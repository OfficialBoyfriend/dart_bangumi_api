...
/// * [data] - 编辑修改内容，响应类型不固定
@BuiltValue()
abstract class DetailedRevision implements Built<DetailedRevision, DetailedRevisionBuilder> {
  ...
  factory DetailedRevision([void updates(DetailedRevisionBuilder b)]) = _$DetailedRevision;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DetailedRevisionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DetailedRevision> get serializer => _$DetailedRevisionSerializer();
}

class _$DetailedRevisionSerializer implements PrimitiveSerializer<DetailedRevision> {
  @override
