...
/// * [extra] 
@BuiltValue()
abstract class CharacterRevisionDataItem implements Built<CharacterRevisionDataItem, CharacterRevisionDataItemBuilder> {
  ...
  factory CharacterRevisionDataItem([void updates(CharacterRevisionDataItemBuilder b)]) = _$CharacterRevisionDataItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CharacterRevisionDataItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CharacterRevisionDataItem> get serializer => _$CharacterRevisionDataItemSerializer();
}

class _$CharacterRevisionDataItemSerializer implements PrimitiveSerializer<CharacterRevisionDataItem> {
  @override
  final Iterable<Type> types = const [CharacterRevisionDataItem, _$CharacterRevisionDataItem];
