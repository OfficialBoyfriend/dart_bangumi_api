...
/// * [actors] - 演员列表
@BuiltValue()
abstract class RelatedCharacter implements Built<RelatedCharacter, RelatedCharacterBuilder> {
  ...
  factory RelatedCharacter([void updates(RelatedCharacterBuilder b)]) = _$RelatedCharacter;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RelatedCharacterBuilder b) => b
      ..actors = ListBuilder();

  @BuiltValueSerializer(custom: true)
  static Serializer<RelatedCharacter> get serializer => _$RelatedCharacterSerializer();
}

class _$RelatedCharacterSerializer implements PrimitiveSerializer<RelatedCharacter> {
  @override
