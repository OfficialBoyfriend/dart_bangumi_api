...
/// * [relation] 
@BuiltValue()
abstract class RelatedPerson implements Built<RelatedPerson, RelatedPersonBuilder> {
  ...
  factory RelatedPerson([void updates(RelatedPersonBuilder b)]) = _$RelatedPerson;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RelatedPersonBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RelatedPerson> get serializer => _$RelatedPersonSerializer();
}
