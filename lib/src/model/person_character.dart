...
/// * [staff] 
@BuiltValue()
abstract class PersonCharacter implements Built<PersonCharacter, PersonCharacterBuilder> {
  ...
  factory PersonCharacter([void updates(PersonCharacterBuilder b)]) = _$PersonCharacter;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PersonCharacterBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PersonCharacter> get serializer => _$PersonCharacterSerializer();
}

class _$PersonCharacterSerializer implements PrimitiveSerializer<PersonCharacter> {
  @override
