...
/// * [type] 
@BuiltValue()
abstract class PutUserEpisodeCollectionRequest implements Built<PutUserEpisodeCollectionRequest, PutUserEpisodeCollectionRequestBuilder> {
  ...
  factory PutUserEpisodeCollectionRequest([void updates(PutUserEpisodeCollectionRequestBuilder b)]) = _$PutUserEpisodeCollectionRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PutUserEpisodeCollectionRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PutUserEpisodeCollectionRequest> get serializer => _$PutUserEpisodeCollectionRequestSerializer();
}

class _$PutUserEpisodeCollectionRequestSerializer implements PrimitiveSerializer<PutUserEpisodeCollectionRequest> {
  @override
  final Iterable<Type> types = const [PutUserEpisodeCollectionRequest, _$PutUserEpisodeCollectionRequest];
