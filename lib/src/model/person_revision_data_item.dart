...
/// * [prsnName] 
@BuiltValue()
abstract class PersonRevisionDataItem implements Built<PersonRevisionDataItem, PersonRevisionDataItemBuilder> {
  ...
  factory PersonRevisionDataItem([void updates(PersonRevisionDataItemBuilder b)]) = _$PersonRevisionDataItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PersonRevisionDataItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PersonRevisionDataItem> get serializer => _$PersonRevisionDataItemSerializer();
}

class _$PersonRevisionDataItemSerializer implements PrimitiveSerializer<PersonRevisionDataItem> {
  @override
  final Iterable<Type> types = const [PersonRevisionDataItem, _$PersonRevisionDataItem];
