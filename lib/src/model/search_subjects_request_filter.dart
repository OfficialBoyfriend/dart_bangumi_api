...
@BuiltValue()
abstract class SearchSubjectsRequestFilter implements Built<SearchSubjectsRequestFilter, SearchSubjectsRequestFilterBuilder> {
  ...
  factory SearchSubjectsRequestFilter([void updates(SearchSubjectsRequestFilterBuilder b)]) = _$SearchSubjectsRequestFilter;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SearchSubjectsRequestFilterBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SearchSubjectsRequestFilter> get serializer => _$SearchSubjectsRequestFilterSerializer();
}

class _$SearchSubjectsRequestFilterSerializer implements PrimitiveSerializer<SearchSubjectsRequestFilter> {
  @override
  final Iterable<Type> types = const [SearchSubjectsRequestFilter, _$SearchSubjectsRequestFilter];
