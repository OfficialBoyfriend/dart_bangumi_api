...
/// * [data] 
@BuiltValue()
abstract class CharacterRevision implements Revision, Built<CharacterRevision, CharacterRevisionBuilder> {
  @BuiltValueField(wireName: r'data')
  BuiltMap<String, CharacterRevisionDataItem>? get data;

  CharacterRevision._();

  factory CharacterRevision([void updates(CharacterRevisionBuilder b)]) = _$CharacterRevision;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CharacterRevisionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CharacterRevision> get serializer => _$CharacterRevisionSerializer();
}

class _$CharacterRevisionSerializer implements PrimitiveSerializer<CharacterRevision> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.data != null) {
      ...
      yield serializers.serialize(
        object.data,
        specifiedType: const FullType(BuiltMap, [FullType(String), FullType(CharacterRevisionDataItem)]),
      );
    }
    yield r'type';
    yield serializers.serialize(
