...
/// * [relation] 
@BuiltValue()
abstract class V0SubjectRelation implements Built<V0SubjectRelation, V0SubjectRelationBuilder> {
  ...
  factory V0SubjectRelation([void updates(V0SubjectRelationBuilder b)]) = _$V0SubjectRelation;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0SubjectRelationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0SubjectRelation> get serializer => _$V0SubjectRelationSerializer();
}

class _$V0SubjectRelationSerializer implements PrimitiveSerializer<V0SubjectRelation> {
  @override
