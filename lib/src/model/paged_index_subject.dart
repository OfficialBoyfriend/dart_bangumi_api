...
/// * [data] 
@BuiltValue()
abstract class PagedIndexSubject implements Built<PagedIndexSubject, PagedIndexSubjectBuilder> {
  ...
  factory PagedIndexSubject([void updates(PagedIndexSubjectBuilder b)]) = _$PagedIndexSubject;
  ...
  static Serializer<PagedIndexSubject> get serializer => _$PagedIndexSubjectSerializer();
}

class _$PagedIndexSubjectSerializer implements PrimitiveSerializer<PagedIndexSubject> {
  @override
