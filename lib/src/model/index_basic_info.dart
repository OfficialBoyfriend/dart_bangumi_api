...
/// * [description] 
@BuiltValue()
abstract class IndexBasicInfo implements Built<IndexBasicInfo, IndexBasicInfoBuilder> {
  ...
  factory IndexBasicInfo([void updates(IndexBasicInfoBuilder b)]) = _$IndexBasicInfo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IndexBasicInfoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IndexBasicInfo> get serializer => _$IndexBasicInfoSerializer();
}

class _$IndexBasicInfoSerializer implements PrimitiveSerializer<IndexBasicInfo> {
  @override
