...
/// * [type] 
@BuiltValue()
abstract class UserEpisodeCollection implements Built<UserEpisodeCollection, UserEpisodeCollectionBuilder> {
  ...
  factory UserEpisodeCollection([void updates(UserEpisodeCollectionBuilder b)]) = _$UserEpisodeCollection;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UserEpisodeCollectionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UserEpisodeCollection> get serializer => _$UserEpisodeCollectionSerializer();
}

class _$UserEpisodeCollectionSerializer implements PrimitiveSerializer<UserEpisodeCollection> {
  @override
  final Iterable<Type> types = const [UserEpisodeCollection, _$UserEpisodeCollection];
