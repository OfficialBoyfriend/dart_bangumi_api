...
/// * [actor] 
@BuiltValue()
abstract class PersonRevisionProfession implements Built<PersonRevisionProfession, PersonRevisionProfessionBuilder> {
  ...
  factory PersonRevisionProfession([void updates(PersonRevisionProfessionBuilder b)]) = _$PersonRevisionProfession;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PersonRevisionProfessionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PersonRevisionProfession> get serializer => _$PersonRevisionProfessionSerializer();
}

class _$PersonRevisionProfessionSerializer implements PrimitiveSerializer<PersonRevisionProfession> {
  @override
  final Iterable<Type> types = const [PersonRevisionProfession, _$PersonRevisionProfession];
