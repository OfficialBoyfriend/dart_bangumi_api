...
/// * [voteField] 
@BuiltValue()
abstract class SubjectRevisionData implements Built<SubjectRevisionData, SubjectRevisionDataBuilder> {
  ...
  factory SubjectRevisionData([void updates(SubjectRevisionDataBuilder b)]) = _$SubjectRevisionData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SubjectRevisionDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubjectRevisionData> get serializer => _$SubjectRevisionDataSerializer();
}

class _$SubjectRevisionDataSerializer implements PrimitiveSerializer<SubjectRevisionData> {
  @override
  final Iterable<Type> types = const [SubjectRevisionData, _$SubjectRevisionData];
