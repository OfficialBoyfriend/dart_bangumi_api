...
/// * [image] 
@BuiltValue()
abstract class V0RelatedSubject implements Built<V0RelatedSubject, V0RelatedSubjectBuilder> {
  ...
  factory V0RelatedSubject([void updates(V0RelatedSubjectBuilder b)]) = _$V0RelatedSubject;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V0RelatedSubjectBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V0RelatedSubject> get serializer => _$V0RelatedSubjectSerializer();
}

class _$V0RelatedSubjectSerializer implements PrimitiveSerializer<V0RelatedSubject> {
  @override
